...
function Airesearch() {
    ...
    const { data: files, isLoading } = trpc.getAiresearch.useQuery();
    ...
    const { mutate: deleteFile } = trpc.deletes3File.useMutation({
        onSuccess: () => {
                ...
                files && files?.length !== 0 ? (
                                                ...
                                                <TableRow key={file.id}>
                                                    <TableCell className="hidden sm:table-cell">
                                                        <div className=' flex items-center justify-center overflow-hidden '>
                                                            ...
                                                            ) : (file.key.endsWith('.docx') || file.key.endsWith('.doc')) ? (
                                                                <div>
                                                                    <Wordsvg />
                                                                </div>
                                                            ) : (file.key.endsWith('.pptx') || file.key.endsWith('.ppt')) ? (
                                                                <div>
                                                                    <PPTsvg />
                                                                </div>
                                                            ) : (file.key.endsWith('/url')) ? (
                                                                <div>
                                                                    <Urlsvg />
                                                                </div>
                                                            ) : null}
                    ...
                    <div className='mt-3 flex flex-col items-center gap-2'>
                        ...
                        <h3 className='font-semibold text-xl'>
                            Create your first research report done by AI ...
                        </h3>
